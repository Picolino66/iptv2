...
?>
<div id="section-contador-<?=$conteudo_id?>" class="container-fluid animate-effect" style="padding-top:40px; padding-bottom:80px; background-color: <?=$cores[24]?>" >
		...
		<div class='row' >
			<div class='col-xs-12 col-sm-12 col-md-12' >
				<div>
					...
					<div class="titulo_padrao_linha" style="color:<?=$cores[25]?>; " ></div> 
				</div>
			</div>
		</div>
	...
	foreach ($contadores_lista as $key => $value) {
		...
		echo "
		<div class='contador_div $classes_css'>

		<div class='contador_img' ><img src='".$value['imagem']."' class='".$classes_css_img."' ></div>
